...
!function () {
    ...
    $("body").append("<div id='flagchasercontainer' style='display: none;'><div id='btnchaseauto' style='display: block;position: absolute;left: 50%;margin: -75px -25px -175px;bottom: 350px;width: 50px;height: 25px;padding: 5px;background: rgba(0,0,0,0.5);border-radius: 0;text-align: center;color: #b4b4b4;font-size: 15px;cursor: pointer;'>Auto</div><div id='btnchaseblueflag' style='display: block;position: absolute;left: 50%;margin: -75px -85px -125px;bottom: 300px;width: 50px;height: 25px;padding: 5px;background: rgba(46,110,236,0.5);border-radius: 5px 0 0 5px;text-align: center;color: #b4b4b4;font-size: 15px;cursor: pointer;'>Blue</div><div id='btnchaseredflag' style='display: block;position: absolute;left: 50%;margin: -75px 100px -75px 35px;bottom: 250px;width: 50px;height: 25px;padding: 5px;background: rgba(188,42,47,0.5);border-radius: 0 5px 5px 0;text-align: center;color: #b4b4b4;font-size: 15px;cursor: pointer;'>Red</div></div>");
